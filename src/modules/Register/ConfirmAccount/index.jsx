      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 mx-auto">
            ...
            <div>
              {Object.keys(this.props.resend_success).length > 0 && <div></div>}
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-md-6 mx-auto">
            ...
            <Formik
              ...
              validationSchema={Yup.object().shape({
                otp: Yup.string()
                  .matches(/^[0-9]+$/, "OTP only allows numeric.")
                ...
                return (
                  <form onSubmit={handleSubmit}>
                    <div className="form-group">
                      <label htmlFor="otp">
                        OTP for Email: {this.props.email}
                      </label>
                      <input
                        type="text"
                        id="otp"
                    ...
                    <div className="form-group">
                      ...
                      <button
                        type="button"
                        className="btn btn-warning resend-btn"
                        onClick={this.handleOTPResendBtn}
